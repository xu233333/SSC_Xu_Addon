...
public class JumpClashPower extends Power {
    ...
    public JumpClashPower(PowerType<?> type, LivingEntity entity,
    ...
    public void tick() {
        ...
        } else if (wasOnGround && this.isActive() && player.getVelocity().y > 0) {
            // 从地面潜行跳跃时触发
            isActive = true;
            activeTicks = 0;
            wasOnGround = false;
    ...
    public static PowerFactory<?> createFactory() {
        return new PowerFactory<>(
                SSCXuAddon.identifier("jump_clash"),
                ...
                data -> (type, entity) -> new JumpClashPower(
                        type,
                        entity,
