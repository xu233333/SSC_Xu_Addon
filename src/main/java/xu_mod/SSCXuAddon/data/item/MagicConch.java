...
public class MagicConch extends Item {
    ...
    public static ArrayList<Text> SecretMessages = new ArrayList<>();  // 先咕了这个功能 反正是彩蛋 不是主要功能
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        if (user instanceof PlayerEntity player && !world.isClient) {
            ...
            if (r.nextInt(100) >= 0) {  // 由于没写彩蛋 先禁用彩蛋 大约彩蛋概率为1%
                ...
                player.sendMessage(SecretMessages.get(r.nextInt(SecretMessages.size())), false);
            }
