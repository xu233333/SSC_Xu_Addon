...
public class AllayResourceRender implements IManaRender {
    private static final MinecraftClient mc = MinecraftClient.getInstance();
    private static final Identifier BarTexID = SSCXuAddon.identifier("textures/gui/allay_bar.png");
    ...
    private void renderBar(DrawContext context, float tickDelta, int x, int y) {
        ...
        context.drawText(mc.textRenderer, manaText, x, y - 8, 0xFF7F00FF, false);
    }
}
